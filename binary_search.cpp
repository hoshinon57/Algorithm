 ...
 * ABC034-D 平均値の最大化
 * ABC063-D
 * ABC107-D 中央値は答で二分探索 難問だが典型要素たっぷりの良問
 * ABC130-D 尺取り法も可
 * ABC144-E
 * ABC149-E 難しかったが面白かった
 * ABC155-D 場合分けが多く大変だった
 * ABC174-E
 * ABC192-D 難しかった
 * ABC203-D 難しかった
 * ABC205-D
 ...
 * ABC313-E (別解)
 * ABC312-C
 * ABC319-D 単なる二部探索だが、判定関数をバグらせてACできなかった。大反省
 * ABC324-F 平均値の最大化
 * ABC330-F
 * ABC341-D
 * ABC346-F 難しかったが面白かった
 * ABC364-D 「k番目の要素は？」およびダブル二分探索 良問
 * ABC373-E 実装大変だった 良問
 * ABC374-E 難しかった コスパ良しあしに関する典型
 * ABC381-E 難しかった 実装も大変
 * ABC389-E 難しかった オーバーフローにも要注意 良問
